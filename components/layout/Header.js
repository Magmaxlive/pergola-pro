                                ...
                                <div className="menu-wrap">
                                    <nav className="menu-nav">
                                        <div className="logo different-logo">
                                            <Link href="/"><img src="/assets/img/logo/logo_02.png" alt="Logo" style={{ width: "120px" }} /></Link>
                                        </div>
                                        <div className="logo d-none">
                                            <Link href="/"><img src="/assets/img/logo/logo_02.png" alt="Logo" style={{ width: "110px" }} /></Link>
                                        </div>
                                        ...
                                        <div className="header-action d-none d-md-block">
                                            <ul className="list-wrap">
                                                <li className="header-btn"><Link href="/contact" className="btn" style={{ fontSize: "14px" }}>Get a Quoute</Link></li>
                                            </ul>
                                        </div>
                                    </nav>
                                </div>
